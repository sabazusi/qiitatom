...
export default class extends React.Component {
  ...
  componentDidUpdate() {
    ...
    if (this.state.currentContentId === null) {
      ...
      const paneHeight = document.getElementsByClassName('qiitatomSearchResultView')[0].clientHeight;
      const buttonHeight = document.getElementsByClassName('qiitatomBackToResultViewButton')[0].clientHeight;
  ...
  showContent() {
    ...
    return target ? (
      <div className="qiitatom__result__post-container">
        <div className="qiitatomBackToResultViewButton">
    ...
    return currentContentId !== null ? this.showContent() : (
      <div className="qiitatomResultViewContainer" ref="container">
        ...
        <div className="qiitatomResultViewHeaderLabel">
          <span className="qiitatomSearchQuery">{query}</span> の結果検索結果({currentPage} / {totalPage}ページ)
        </div>
