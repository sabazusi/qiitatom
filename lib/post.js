  ...
  static content() {
    this.div({class: 'qiitatompost'}, () => {
      this.div({class: 'qiitatomPostInput'}, () => {
        ...
        this.div({class: 'qiitatom__post__modal-buttons'}, () => {
          this.label({outlet: 'targetFileName', class: 'qiitatom__post__modal-filename-label'}, '');
          this.button({outlet: 'previewButton', class: 'qiitatomPostPreviewButton'}, 'プレビューを表示する');
        });
      });
    });
  }
